defmodule Rumbl.MultimediaTest do
  ...
  describe "categories" do
    test "list_alphabetical_categories/0" do
      ...
      assert alpha_name == ~w(Action Comedy Drama)
    end
  end
  ...
  describe "videos" do
    ...
    test "get_videos!/1 returns the video with given id" do
      owner = user_fixture()
    ...
    test "update_video/2 with invalid data returns error channel" do
      owner = user_fixture()
